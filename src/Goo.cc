...
v8::Handle<v8::Value> Goo::Test1(const v8::Arguments& args) {

std::cout << "\nCreate document" << std::endl;
	xmlDocPtr doc = xmlParseDoc(BAD_CAST "<hello><world>hi</world><world2>hi2</world2></hello>");

std::cout << "\nNormal node" << std::endl;
	xmlNodePtr worldNode = doc->children->children;
std::cout << "doc: " << worldNode->doc << " parent: " << worldNode->parent << std::endl;

std::cout << "\nDoc copied node" << std::endl;
	xmlNodePtr copiedNode = xmlDocCopyNode(worldNode, doc, 1);
std::cout << "doc: " << copiedNode->doc << " parent: " << copiedNode->parent << std::endl;

std::cout << "\nDoc copied then appended node" << std::endl;
	xmlNodePtr appendedNode = xmlDocCopyNode(worldNode, doc, 1);
	xmlAddChild(doc->children, appendedNode);
std::cout << "doc: " << appendedNode->doc << " parent: " << appendedNode->parent << std::endl;

std::cout << "\nUnlinked node" << std::endl;
	xmlNodePtr unlinkedNode = doc->children->children->next;
	xmlUnlinkNode(unlinkedNode);
std::cout << "doc: " << unlinkedNode->doc << " parent: " << unlinkedNode->parent << std::endl;

std::cout << "\nNew doc node" << std::endl;
	xmlNodePtr newDocNode = xmlNewDocNode(doc, NULL, BAD_CAST "newDocNode", NULL);
std::cout << "doc: " << newDocNode->doc << " parent: " << newDocNode->parent << std::endl;

std::cout << "\nNew doc text node" << std::endl;
	xmlNodePtr newDocText = xmlNewDocText(doc, BAD_CAST "newDocText");
std::cout << "doc: " << newDocText->doc << " parent: " << newDocText->parent << std::endl;
...
std::cout << "canNOT free normal node after free doc" << std::endl;
std::cout << "doc: " << worldNode->doc << " parent: " << worldNode->parent << std::endl;

std::cout << "CAN free copied node after free doc" << std::endl;
std::cout << "doc: " << copiedNode->doc << " parent: " << copiedNode->parent << std::endl;
	xmlFreeNode(copiedNode);

std::cout << "canNOT free copied then appended node after free doc" << std::endl;
std::cout << "doc: " << appendedNode->doc << " parent: " << appendedNode->parent << std::endl;

std::cout << "CAN free unlinked node after free doc" << std::endl;
std::cout << "doc: " << unlinkedNode->doc << " parent: " << unlinkedNode->parent << std::endl;
	xmlFreeNode(unlinkedNode);

std::cout << "CAN free new doc node after free doc" << std::endl;
std::cout << "doc: " << newDocNode->doc << " parent: " << newDocNode->parent << std::endl;
	xmlFreeNode(newDocNode);

std::cout << "CAN free new text node after free doc" << std::endl;
std::cout << "doc: " << newDocText->doc << " parent: " << newDocText->parent << std::endl;
